          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-3 py-2 bg-[#1f1f1f] border border-[#14b8a6] text-[#14b8a6] text-xs font-bold uppercase rounded hover:bg-[#14b8a6] hover:text-black transition-all"
                title="Show tutorial"
              >
                Tutorial
              </button>
              <button
                ...
                className="px-3 py-2 bg-[#1f1f1f] border border-[#333333] text-[#999999] text-xs font-bold uppercase rounded hover:bg-[#252525] hover:border-[#14b8a6] hover:text-[#14b8a6] transition-all"
